...
print('tvec: ', tvec, 'size: ', tvec.size)
...
print('before stim: ', vwout1p, 'size: ', vwout1p.size)
print('during stim: ', vwout1pe, 'size: ', vwout1pe.size)
print('after stim: ', vwout2p, 'size: ', vwout2p.size)
...
# Initial frame for plotting. The system is at the equilibrium (before electrical stimulation).
...
print('2d: ', vwoutp)
print('frameq: ',frameq)
print('1d: ',vwoutp[frameq])
print('value: ',vwoutp[frameq, 0])
print('value: ',vwoutp[frameq][0])
